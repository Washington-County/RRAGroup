...
public_schools_char_source <- read_xlsx(here("summarising_data", "data", "Public_School_Characteristics.xlsx"),
  sheet = 1)
...
get_county_counts_function_2 <- function(variable){
...
hispanic_students_county_2 <- get_county_counts_function_2(Hispanic)

black_students_county_2 <- get_county_counts_function_2(Black)

total_teachers_county_2 <- get_county_counts_function_2(total_teachers)
